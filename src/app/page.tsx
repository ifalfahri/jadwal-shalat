    ...
    <main className="min-h-screen bg-gradient-to-b from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <footer className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
          Data provided by <Link className="hover:text-emerald-500" href="https://documenter.getpostman.com/view/841292/2s9YsGittd">MyQuran API</Link> © {new Date().getFullYear()}
        </footer>
      </div>
    </main>
  )
